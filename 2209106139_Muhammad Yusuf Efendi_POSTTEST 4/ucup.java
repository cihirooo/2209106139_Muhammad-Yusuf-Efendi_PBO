...
class MieInstanRasaAyam extends MieInstan {
    ...
    // Mungkin ada metode tambahan yang spesifik untuk MieInstanRasaAyam
}

    // Overriding method dari kelas induk MieInstan
...
class MieInstanRasaSoto extends MieInstan {
    ...
    // Mungkin ada metode tambahan yang spesifik untuk MieInstanRasaSoto
}
...
public class ucup {
    ...
    private static void tambahMieInstan(MieInstan mieInstan) {
        dataMie.add(mieInstan);
    }
